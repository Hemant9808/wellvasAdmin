  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="flex items-center justify-between p-4 border-b">
        {isExpanded && <h1 className="text-xl font-bold text-gray-800">Wellvas Admin</h1>}
        <button
          onClick={() => {
      ...
      <div className="mt-auto p-4 border-t">
        <div className="flex items-center">
          ...
          {isExpanded && (
            <div className=" flex-wrap gap-2 ml-3 flex justify-between w-full">
              <div>
              ...
              <button
                ...
                className="ml-3 bg-red-500 text-white text-sm px-2 py-1 rounded"
              >
                Logout
              </button>
            </div>
